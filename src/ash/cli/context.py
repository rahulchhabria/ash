...
OPENAI_MODELS = [
    ...
    ("gpt-5.2", "GPT-5.2 (Coding harness default)"),
]
...
def get_config(config_path: Path | None = None) -> AshConfig:
    ...
    try:
        ...
        error("No configuration found. Run 'pigeon init' first.")
...
def generate_config_template() -> str:
    ...
    codex_model = OPENAI_MODELS[2][0]  # gpt-5.2

    return f'''# Pigeon Configuration
# Generated by: pigeon init
#
# Fill in your API key below, then run: pigeon upgrade
...
# Models
# =============================================================================
# GPT-5.2 as default, Fast for lightweight tasks, Codex alias for coding
